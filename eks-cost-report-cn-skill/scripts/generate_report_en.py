#!/usr/bin/env python3
"""EKS OpenCost HTML Report Generator (English)

Usage:
    python3 generate_report_en.py --window 1d --offset 1d --output report.html
"""
...
<title>EKS OpenCost Cost Analysis Report</title>
...
<div class="container">
<header>
  <h1>☁️ EKS OpenCost Cost Analysis Report</h1>
...
<div class="summary-cards">
  <div class="card total">
    ...
    <div class="sub">Including Idle · ${grand_total:.4f}</div>
  </div>
  <div class="card cpu">
    <div class="label">Used Cost</div>
    <div class="value">¥{allocated_total*CNY_RATE:.2f}</div>
    <div class="sub">Excluding Idle · {(allocated_total/grand_total*100) if grand_total>0 else 0:.1f}%</div>
  </div>
  <div class="card ram">
...
<div class="alert">
  <div class="alert-title">⚠️ Low Efficiency Warning</div>
  <div class="alert-text">Overall CPU efficiency is very low; most resource requests are far higher than actual usage. Please review resource request settings for each namespace.</div>
</div>

<div class="chart-grid">
  <div class="chart-container">
    <h3>Namespace Cost Distribution</h3>
    <canvas id="nsChart"></canvas>
  </div>
  <div class="chart-container">
    <h3>Cost Composition (CNY)</h3>
    <canvas id="costChart"></canvas>
  </div>
</div>

<div class="section">
<h2>1. Node-level Cost</h2>
<table>
  <thead><tr><th>Node</th><th class="text-right">CPU</th><th class="text-right">RAM</th><th class="text-right">PV</th><th class="text-right">LB</th><th class="text-right">Total</th><th class="text-right">CPU Idle</th><th class="text-right">RAM Idle</th><th class="text-right">Idle Total</th><th class="text-center">CPU Efficiency</th></tr></thead>
  <tbody>
"""
...
<div class="section">
  <h2>2. Namespace-level Cost</h2>
  <table>
    <thead><tr><th>Namespace</th><th class="text-right">CPU</th><th class="text-right">RAM</th><th class="text-right">PV</th><th class="text-right">LB</th><th class="text-right">Total</th><th class="text-center">Share</th><th class="text-center">CPU Efficiency</th></tr></thead>
    <tbody>
"""
...
<div class="section">
  <h2>3. Service-level Cost (Top 15)</h2>
  <table>
    <thead><tr><th>Service</th><th class="text-right">CPU</th><th class="text-right">RAM</th><th class="text-right">LB</th><th class="text-right">Total</th><th class="text-center">Share</th></tr></thead>
    <tbody>
"""
...
<div class="section">
  <h2>4. Pod-level Cost (Top 20)</h2>
  <table>
    <thead><tr><th>Pod</th><th class="text-right">CPU</th><th class="text-right">RAM</th><th class="text-right">LB</th><th class="text-right">Total</th></tr></thead>
    <tbody>
"""
...
<div class="section">
  ...
  <div class="insights">
    ...
    <ul>
      <li><strong>Low CPU efficiency:</strong> Most namespaces have CPU efficiency &lt;5%; consider adjusting resource requests</li>
      <li><strong>Load Balancer cost review:</strong> Confirm whether ELBs are necessary, or switch to ClusterIP + Ingress to reduce cost</li>
      <li><strong>DaemonSet cost:</strong> DaemonSets such as cloudwatch-agent and fluent-bit may be significant; verify configuration necessity</li>
      <li><strong>Prometheus replicas:</strong> Evaluate whether multi-replica HA configuration is required</li>
      <li><strong>Node scale:</strong> Overall CPU efficiency is low; consider reducing node count or using smaller instance types</li>
    </ul>
  </div>
</div>
...
def main():
    parser = argparse.ArgumentParser(description='EKS OpenCost HTML Report Generator (English)')
    ...
    if args.output is None:
        ...
        args.output = f"/home/ubuntu/opencost-report-en-{date_str}.html"
